...
<head>
  ...
  <style>
    *{box-sizing:border-box;}
    ...
    .sidebar{width:240px;flex-shrink:0;background:linear-gradient(180deg,#0369a1 0%,#0c4a7a 60%,#082f5a 100%);min-height:100vh;display:flex;flex-direction:column;padding:1.5rem 1rem;position:sticky;top:0;height:100vh;overflow-y:auto;}
    ...
    .sb-link.on{background:rgba(14,165,233,.25);color:#fff;border:1px solid rgba(14,165,233,.3);}
...
<aside class="sidebar">
  ...
  @foreach([['admin.dashboard','📊','Dashboard'],['admin.users','👥','Kelola User'],['admin.scholarships.index','🎓','Beasiswa'],['admin.whatsapp.index','💬','WA Blast'],['admin.statistik','📈','Statistik']] as [$r,$ico,$l])
